...
elif [ "$soc_id" -eq 657 ]; then
    setprop ro.vendor.qti.soc_name volcano
    setprop ro.vendor.qti.soc_model QCM6690
elif [ "$soc_id" -eq 658 ]; then
    setprop ro.vendor.qti.soc_name volcano
    setprop ro.vendor.qti.soc_model QCS6690
elif [ "$soc_id" -eq 629 ] || [ "$soc_id" -eq 652 ]; then
    setprop ro.vendor.qti.soc_name niobe
    setprop ro.vendor.qti.soc_model SXR2330P
